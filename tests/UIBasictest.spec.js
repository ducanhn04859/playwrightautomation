...
test.describe("Login page", () => {
  ...
  test.only("Login page in ", async ({ page }) => {
    ...
    // fill form
    await email.fill("bob@gmail.com");
    await passWord.fill("123@123aB");
    await logInBtn.click();
    await expect(page).toHaveTitle("Let's Shop");
    await page.waitForLoadState("networkidle");
    const listTitle = await page.locator(".card-body b").allTextContents();
    console.log(456 + listTitle);
  });
});
